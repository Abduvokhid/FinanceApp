...
class MortgageView: UIView, UITextFieldDelegate, Slide {
    ...
    @IBAction func helpButtonPressed(_ sender: UIButton) {
        ...
        helpPage.helpText = "<b>Initial amount</b> – This field it is required to insert the amount of money that the user currently is planning to take from the bank for the mortgage.</br><i>Please leave this field empty if you are looking for the Initial amount.</i></br></br><b>Payment amount</b> – In this field, it is required to insert the amount of money the user is planning to pay back monthly.</br><i>Please leave this field empty if you are looking for the Payment amount.</i></br></br><b>Interest Rate</b> - In this field, it’s required to insert the interest rate stablished for the mortgage.</br><i>This field cannot be empty.</i></br></br><b>Number of years</b> - In this field, it’s required to insert the period of time (years) within what user expects to pay back the mortgage.</br><i>Please leave this field empty if you are looking for Number of years.</i></br></br><b>Calculate</b> – press Calculate button to get the desired result.</br><i>Please leave empty the text field you are expecting to get the result for.</i>"
